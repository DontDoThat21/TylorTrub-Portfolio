...
namespace Portfolio.Server.BL.Migrations
{
    ...
    [Migration("20230608151550_FixedProjectSeeds")]
    partial class FixedProjectSeeds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.DTO.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.Motorcycle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AddDate = new DateTime(2023, 6, 8, 11, 15, 50, 304, DateTimeKind.Local).AddTicks(7152),
                            Brakes = "Brembo",
                        ...
                        {
                            Id = 2,
                            AddDate = new DateTime(2023, 6, 8, 11, 15, 50, 304, DateTimeKind.Local).AddTicks(7199),
                            Brakes = "Brembo",
                        ...
                        {
                            Id = 3,
                            AddDate = new DateTime(2023, 6, 8, 11, 15, 50, 304, DateTimeKind.Local).AddTicks(7202),
            ...
            modelBuilder.Entity("Portfolio.DTO.MotorcycleVideo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.PortfolioImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Portfolio.DTO.OrderDetail", b =>
                {
                    b.HasOne("Portfolio.DTO.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Portfolio.DTO.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Portfolio.DTO.OrderHeader", b =>
                {
                    b.HasOne("Portfolio.DTO.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Portfolio.DTO.Product", b =>
                {
                    b.HasOne("Portfolio.DTO.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Portfolio.DTO.ApplicationUser", b =>
                {
                    b.HasOne("Portfolio.DTO.Company", "Company")
                        .WithMany()
