...
namespace Portfolio.Server.BL.Migrations
{
    ...
    [Migration("20230526212331_addShoppingCartToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.DTO.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Portfolio.DTO.Motorcycle", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AddDate = new DateTime(2023, 5, 26, 17, 23, 31, 147, DateTimeKind.Local).AddTicks(1980),
                            Brakes = "Brembo",
                        ...
                        {
                            Id = 2,
                            AddDate = new DateTime(2023, 5, 26, 17, 23, 31, 147, DateTimeKind.Local).AddTicks(2027),
                            Brakes = "Brembo",
                        ...
                        {
                            Id = 3,
                            AddDate = new DateTime(2023, 5, 26, 17, 23, 31, 147, DateTimeKind.Local).AddTicks(2030),
            ...
            modelBuilder.Entity("Portfolio.DTO.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Portfolio.DTO.Models.ShoppingCart", b =>
                {
                    b.HasOne("Portfolio.DTO.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
