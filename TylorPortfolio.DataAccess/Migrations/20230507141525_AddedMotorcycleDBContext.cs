...
{
    /// <inheritdoc />
    public partial class AddedMotorcycleDBContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 5, 7, 10, 15, 24, 948, DateTimeKind.Local).AddTicks(1514), "Brembo", "Four Stroke V4", "0", "Yamaha", 998, "Yamaha MT-10", "yamahamt10.jpg", "110.8ft", (byte)19 },
                    { 2, new DateTime(2023, 5, 7, 10, 15, 24, 948, DateTimeKind.Local).AddTicks(1560), "Brembo", "Four Stroke Supercharged", "0", "Kawasaki", 998, "Kawasaki H2-R", "kawasakih2r.png", "115ft", (byte)23 },
                    { 3, new DateTime(2023, 5, 7, 10, 15, 24, 948, DateTimeKind.Local).AddTicks(1563), "1-Disc-Rear, 2-Front", "4-Stroke Twin Boxer", "0", "BMW", 1085, "BMW R1100RS", "bmwk1100caferacer.jpg", "92.9ft", (byte)2 }
                });
        }
